...
st.sidebar.markdown("---")
st.sidebar.markdown("<br> <br> <br> <br> <br> <br> <h1 style='text-align: center; font-size: 18px; color: #0080FF;'>Thrisha Reddy Mareddy</h1>", unsafe_allow_html=True)
...
st.title("Digital Aggression Control ")
st.markdown("---")
